...
public class ShapeEllipse extends Shape {
    ...
    public void draw(Graphics2D g2D) {
        ...
        if (this.m_shapeInfo.getShadingType() == ShapeShadingType.OUTLINE) {
            ...
            g2D.drawOval(this.m_topLeftPoint.getX(), this.m_topLeftPoint.getY(), width, height);

        } else if (this.m_shapeInfo.getShadingType() == ShapeShadingType.FILLED_IN) {
            g2D.setColor(this.m_shapeInfo.getPrimaryColor());
            g2D.fillOval(this.m_topLeftPoint.getX(), this.m_topLeftPoint.getY(), width, height);
    ...
    public void drawOutline(Graphics2D g2D) {
        ...
        g2D.drawOval(this.m_topLeftPoint.getX() - 6, this.m_topLeftPoint.getY() - 6, width + 12, height + 12);
    }
    ...
    public IShape deepCopyShape() {
        ...
        return ShapeFactory.createShapeEllipse(newShapeInfo);
    }
